...
Для мониторинга использовались утилиты \texttt{VisualVM} и встроенный профилировщик IDE. Приложение запускалось на сервере \texttt{WildFly 21.0.0 Final} с JVM \texttt{<указать JVM и версию>}.
